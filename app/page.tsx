  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#E8DDD0] py-3 px-4 md:px-8">
      <div className="max-w-5xl mx-auto relative flex items-center justify-center">
        ...
        <a href="#form" className="absolute left-0 bg-[#6B1A47] text-white text-base font-semibold px-5 py-2 hover:bg-[#4E1235] transition-colors">
          הצטרפות →
        </a>
      </div>
    </nav>
    ...
    <section className="bg-white py-20 md:py-28 px-4 md:px-8">
      <div className="max-w-2xl mx-auto text-center">
        <Fade>
          ...
          <div className="mb-8 card-frame overflow-hidden shadow-lg border border-[#E8DDD0]">
            <video
  ...
  return (
    <section className="bg-[#F9D0CF] py-16 md:py-20 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Fade>
          <div className="bg-white card-frame shadow-lg mb-8 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto">
        <Fade className="text-center mb-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[#6B1A47] font-bold text-2xl md:text-3xl">הוא שיטה.</p>
          </div>
        </Fade>
  ...
  return (
    <section className="bg-[#F5F2E9] py-16 md:py-20">
      ...
      <StaggerFade className="max-w-3xl mx-auto px-4 md:px-8 space-y-4">
        {CHAPTER_DETAILS.map((ch, i) => (
          <motion.div
            key={ch.number}
            variants={fadeUp}
            className={`relative overflow-hidden card-frame px-7 py-7 ${i % 2 === 0 ? "bg-[#6B1A47]" : "bg-[#FAF6F0]"}`}
          >
            <span
      ...
      <Fade className="max-w-3xl mx-auto px-4 md:px-8 mt-10">
        <div className="bg-[#6B1A47] card-frame px-8 py-7 text-center">
  ...
  return (
    <section id="form" className="bg-white py-16 md:py-20 px-4 md:px-8">
      <div className="max-w-lg mx-auto">
        ...
        <Fade>
          <div className="border border-[#E8DDD0] card-frame overflow-hidden">
            ...
            <div className="p-6 md:p-8">
              ...
              >
                <input type="text" placeholder="שם מלא *" required dir="rtl"
                  className="w-full border border-[#E8DDD0] px-4 py-3.5 text-[#1A1218] bg-[#FAF6F0] focus:outline-none focus:border-[#6B1A47] text-right text-lg transition-colors" />
  ...
  return (
    <section className="bg-[#F9D0CF] py-14 md:py-16 px-4 md:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white card-frame px-6 md:px-8 py-2 shadow-md">
